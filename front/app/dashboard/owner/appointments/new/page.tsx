...
import { createAppointment, CreateAppointmentRequest } from "@/app/api/appointments"
...
export default function NewAppointment() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const ownerId = getUserIdFromToken() || (userData && 'id' in userData ? userData.id : '');
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1a0b2e] to-[#2c1250] text-white">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">New Appointment</h1>
          <p className="text-white/70">Schedule a new appointment for a client</p>
        </div>
