...
type User struct {
	...
	Appointments []Appointment `gorm:"many2many:appointment_list;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"appointments"`
	Animals 		 []Animal 		 `gorm:"foreignKey:OwnerID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"animals"`
	Services     []Service     `gorm:"foreignKey:UserID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"services"`
}
